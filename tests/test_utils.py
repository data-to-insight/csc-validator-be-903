...
def test_add_col_to_episodes_CONTINUOUSLY_LOOKED_AFTER():
    ...
    eps = pd.DataFrame([
        ...
        {'CHILD': '999', 'DECOM': '01/03/1970', 'DEC': '31/03/1975', 'LS': 'o', 'REC': 'X1', 'RNE': 'o'},  # not in year
        {'CHILD': '999', 'DECOM': '01/03/1980', 'DEC': '31/03/1985', 'LS': 'o', 'REC': 'X1', 'RNE': 'o'},  # throughout
        {'CHILD': '909090', 'DECOM': '01/03/1970', 'DEC': '31/03/1975', 'LS': 'o', 'REC': 'X1', 'RNE': 'S'}  # not in yr

    ])
    eps = add_col_to_episodes_CONTINUOUSLY_LOOKED_AFTER(eps, collection_start, collection_end)

    assert eps['CONTINUOUSLY_LOOKED_AFTER'].to_list() == [True, True, False, True,
...
def test_add_col_to_tables_CONTINUOUSLY_LOOKED_AFTER():
    ...
    eps = pd.DataFrame([
        ...
        {'CHILD': '303', 'DECOM': '01/03/1970', 'DEC': '31/03/1975', 'LS': 'o', 'REC': 'X1', 'RNE': 'o'},  # not in year
        {'CHILD': '303', 'DECOM': '01/03/1980', 'DEC': '31/03/1985', 'LS': 'o', 'REC': 'X1', 'RNE': 'o'},  # throughout

        {'CHILD': '404040', 'DECOM': '01/03/1970', 'DEC': '31/03/1975', 'LS': 'o', 'REC': 'X1', 'RNE': 'S'}  # not in yr

    ])

    header = pd.DataFrame({'CHILD': ['1', '2', '3', '4', '5555', '6', '7777', '99999999', '404040']})

    oc3 = pd.DataFrame({'CHILD': ['999999', '1', '2', '3', '9999', '8', '303', '404040'],
                        'blahh': ['blahhh', 'x', 'y', 'z', 'dfds', 'q', 'xxx', 'yyyyyy']})

    missing = pd.DataFrame({'CHILD': ['999999', '1', '1', '1', '2', '3', '9999', '8', '303'],
    ...
    assert header['CONTINUOUSLY_LOOKED_AFTER'].to_list() == [True, True, False, True, True, False, False, False, False]
    assert missing['CONTINUOUSLY_LOOKED_AFTER'].to_list() == [False, True, True, True, True, False, False, False, True]
    assert oc3['CONTINUOUSLY_LOOKED_AFTER'].to_list() == [False, True, True, False, False, False, True, False]
