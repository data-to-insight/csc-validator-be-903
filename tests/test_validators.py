...
def test_validate_561():
  fake_placed_adoption = pd.DataFrame([
      {'CHILD': 101, 'DATE_PLACED_CEASED': '26/05/2000', 'DATE_PLACED': '26/05/2019', 'REASON_PLACED_CEASED': 'xx'},  # 0
      {'CHILD': 102, 'DATE_PLACED_CEASED': '01/07/2018', 'DATE_PLACED': '26/05/2000', 'REASON_PLACED_CEASED': 'xx'},  # 1 
      {'CHILD': 103, 'DATE_PLACED_CEASED': '26/05/2000', 'DATE_PLACED': pd.NA, 'REASON_PLACED_CEASED': 'xx'},  # 2
      {'CHILD': 104, 'DATE_PLACED_CEASED': '26/05/2017', 'DATE_PLACED': '01/02/2016', 'REASON_PLACED_CEASED': 'xx'},  # 3 
      {'CHILD': 105, 'DATE_PLACED_CEASED': pd.NA, 'DATE_PLACED': '26/05/2019', 'REASON_PLACED_CEASED': 'xx'},  # 4 
  ])
  fake_pa_last = pd.DataFrame([
      {'CHILD': 101, 'DATE_PLACED_CEASED': pd.NA, 'DATE_PLACED': '26/05/2019', 'REASON_PLACED_CEASED': 'xx'},  # 0 fail
      {'CHILD': 102, 'DATE_PLACED_CEASED': '01/07/2018', 'DATE_PLACED': '26/05/2000', 'REASON_PLACED_CEASED': 'xx'},  # 1 fail
      {'CHILD': 103, 'DATE_PLACED_CEASED': '26/05/2000', 'DATE_PLACED': pd.NA, 'REASON_PLACED_CEASED': 'xx'},  # 2
      {'CHILD': 104, 'DATE_PLACED_CEASED': '26/05/2017', 'DATE_PLACED': '01/02/2016', 'REASON_PLACED_CEASED': 'xx'},  # 3 
      {'CHILD': 105, 'DATE_PLACED_CEASED': pd.NA, 'DATE_PLACED': '26/05/2019', 'REASON_PLACED_CEASED': pd.NA},  # 4 pass
  ])
