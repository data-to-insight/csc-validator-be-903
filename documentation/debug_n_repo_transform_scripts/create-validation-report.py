...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Validate files and write validation report"
    )
    parser.add_argument(
        "files", metavar="FILE", type=str, nargs="+", help="Filenames to validate"
    )
    parser.add_argument(
        "--errors",
        "-e",
        ...
        nargs="?",
        default="all",
        help="Error codes separated with a comma",
    )
