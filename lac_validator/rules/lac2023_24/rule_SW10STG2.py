...
def validate(dfs):
    if "SWEpisodes" not in dfs:
        ...
        m_df = df.merge(
            df_lead, left_on="index", right_on="level_0", suffixes=("", "_prev")
        )
...
def test_validate():
    ...
    fake_data = pd.DataFrame(
        [
            {"CHILD": "1", "SW_DECOM": "01/01/2000", "SW_DEC": "09/01/2000"},
            {"CHILD": "1", "SW_DECOM": "02/01/2000", "SW_DEC": "03/01/2000"},
            {"CHILD": "2", "SW_DECOM": "01/01/1999", "SW_DEC": "09/01/2000"},
            {"CHILD": "2", "SW_DECOM": "01/01/2000", "SW_DEC": "10/01/2000"},
        ]
    )
