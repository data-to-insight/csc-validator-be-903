...
def test_validate():
    ...
    fake_data_header = pd.DataFrame(
        [
            {"CHILD": 101, "SEX": "F", "MOTHER": pd.NA},  # 0 FAIL Ignore: REC is null
            {"CHILD": 102, "SEX": "F", "MOTHER": "0"},  # 1 Ignore: LS is V4
            {"CHILD": 103, "SEX": "F", "MOTHER": pd.NA},  # 2 Ignore: LS is V3
            {"CHILD": 104, "SEX": "F", "MOTHER": pd.NA},  # 3 Ignore: DEC out of range
            {"CHILD": 105, "SEX": "F", "MOTHER": pd.NA},  # 4 FAIL
            {"CHILD": 108, "SEX": "M", "MOTHER": pd.NA},  # 5
            {"CHILD": 109, "SEX": "F", "MOTHER": "0"},  # 6 Ignore: REC is X1
            {"CHILD": 110, "SEX": "F", "MOTHER": pd.NA},  # 7 FAIL
            {"CHILD": 111, "SEX": "F", "MOTHER": "0"},  # 8 Ignore : DEC is null
            {"CHILD": 112, "SEX": "F", "MOTHER": "1"},  # 9
        ]
    )
